                ...
                <div className="section-title">
                    ...
                    <form action="" method="" autoComplete="off">
                        <div className="form-group mb-3">
                            <label htmlFor="" className="form-label d-block">Phone Number</label>
                            <input type="tel" name="" id="phone" className="form-control"
                                placeholder="Enter phone number here..."/>
                        </div>
                        <button type="submit" className="btn bg-red text-white col-12">Next</button>
                    </form>
                </div>
            </div>
        </div>
